...
export const getInventory = async (
  ...
  return basicFetch<GetInventory200>(getGetInventoryUrl(), {
    ...options,
    method: 'GET',
  });
};
...
export const placeOrder = async (
  ...
  return basicFetch<Order>(getPlaceOrderUrl(), {
    ...options,
    method: 'POST',
...
export const getOrderById = async (
  ...
  return basicFetch<Order>(getGetOrderByIdUrl(orderId), {
    ...options,
    method: 'GET',
  });
};
...
export const deleteOrder = async (
  ...
  return basicFetch<unknown>(getDeleteOrderUrl(orderId), {
    ...options,
    method: 'DELETE',
  });
};
